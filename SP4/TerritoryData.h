...
public:
	...
	template<typename IteratorType, typename sortIterator>
	void findAndSort(IteratorType begin, IteratorType end, std::function<bool(TerritorialUnit*)> predicate, std::function<std::vector<TerritorialUnit*>(sortIterator, sortIterator)> sortingPredicate) {
		sortedData = alg_->filterAndSort<TerritorialUnit*, TerritorialUnit*, IteratorType>(begin, end, predicate, sortingPredicate);
	}
